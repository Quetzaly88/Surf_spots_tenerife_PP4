"""
Django settings for surf_spots project.
...
DEBUG = False #set to false before any deplyment . once deployment is completed set it to true locally to continue development. 
